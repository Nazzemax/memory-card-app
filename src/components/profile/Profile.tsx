...
import LogoutLabel from "../../assets/logoutLabel.svg?react";
        ...
        <div className="max-w-full px-[8rem] align-left grow">
          ...
          <div className="flex flex-col items-center">
            <form
              ...
              className="min-w-[25rem] min-h-[22rem] 
            ...
            >
              ...
              {isEditing ? (
                <span className="flex items-center flex-col pt-8">
                  <label
              ...
              <div className="flex flex-center z-10 mt-4 mb-12">
              <button
              ...
              >
                <LogoutLabel className="pr-1 w-4 h-4 stroke-black" />
